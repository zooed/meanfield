...
class DQN(base.ValueNet):
    def __init__(self, sess, env, handle,name, sub_len, memory_size=2**10, batch_size=64, update_every=5):
...
class MFQ(base.ValueNet):
    def __init__(self, sess, env, handle, name, sub_len, eps=1.0, update_every=5, memory_size=2**10, batch_size=64):
